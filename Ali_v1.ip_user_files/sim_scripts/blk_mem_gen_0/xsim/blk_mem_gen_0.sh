...
#
# Generated by Vivado on Mon Sep 12 11:58:56 +0700 2022
...
simulate()
{
  xsim blk_mem_gen_0 -key {Behavioral:sim_1:Functional:blk_mem_gen_0} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/bd_ebcc.protoinst" -protoinst "protoinst_files/design_2.protoinst" -log simulate.log
}
