...
HD_PWD='C:/Users/USER/Documents/GitHub/RISC-V_MALIN/Ali_v1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pipeline_bram_v1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pipeline_bram_v1.tcl
