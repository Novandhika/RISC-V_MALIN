...
HD_PWD='C:/Users/USER/Documents/GitHub/RISC-V_MALIN/Ali_v1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pipeline_bram_v1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pipeline_bram_v1.tcl -notrace
